import{C as g,e as c}from"./assessment-ByzqurOv.js";import"./modulepreload-polyfill-B5Qt9EMX.js";const l={render(i={}){const{id:t="switch",checked:e=!1,onChange:o="",disabled:n=!1}=i,r=e?"checked":"",s=n?"disabled":"",a=n?"":`onclick="SwitchToggle.toggle('${t}', '${o}')"`,d=i.ariaLabel?` aria-label="${i.ariaLabel}"`:"";return`
      <div id="${t}" 
