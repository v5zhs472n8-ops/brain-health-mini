const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./simple-mode-BuKGPT3a.js","./assessment-DenQRj50.js","./modulepreload-polyfill-B5Qt9EMX.js","./assessment-BBC78ghE.css","./app-DLvXa5dK.js","./state-store-BDNRjphJ.js","./simple-report-entry-BDExxS54.js"])))=>i.map(i=>d[i]);
import{C as p,_ as r,e as l,A as u,B as h}from"./assessment-DenQRj50.js";import"./modulepreload-polyfill-B5Qt9EMX.js";const d={textPrimary:"#1d293d",textSecondary:"#62748e",successFill:"#22c55e"},w='<svg width="6rem" height="6rem" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>';class v extends p{async _isEmbeddedSimpleMode(){try{const{SimpleMode:e}=await r(async()=>{const{SimpleMode:t}=await import("./simple-mode-BuKGPT3a.js");return{SimpleMode:t}},__vite__mapDeps([0,1,2,3,4,5]),import.meta.url);return!!e.active}catch{return!1}}onUnmount(){l.stopSpeak()}async handleBack(){var e,t,i;if((t=(e=l).triggerHaptic)==null||t.call(e,"light"),await this._isEmbeddedSimpleMode()){const{SimpleMode:a}=await r(async()=>{const{SimpleMode:s}=await import("./simple-mode-BuKGPT3a.js");return{SimpleMode:s}},__vite__mapDeps([0,1,2,3,4,5]),import.meta.url);a.exit("splash");return}(i=window.App)==null||i.navigate("splash")}async handleRetake(){var a,s,c;(s=(a=l).triggerHaptic)==null||s.call(a,"medium");const e=((c=u.getSnapshot())==null?void 0:c.name)||"",{AssessmentManager:t}=await r(async()=>{const{AssessmentManager:o}=await import("./assessment-DenQRj50.js").then(n=>n.aZ);return{AssessmentManager:o}},__vite__mapDeps([1,2,3]),import.meta.url);if(await this._isEmbeddedSimpleMode()){const{SimpleMode:o}=await r(async()=>{const{SimpleMode:n}=await import("./simple-mode-BuKGPT3a.js");return{SimpleMode:n}},__vite__mapDeps([0,1,2,3,4,5]),import.meta.url);await o.restartForRetake(e);return}if(!await t.advanceToNext(e)){const{Utils:o}=await r(async()=>{const{Utils:n}=await import("./assessment-DenQRj50.js").then(m=>m.a_);return{Utils:n}},__vite__mapDeps([1,2,3]),import.meta.url);o.showToast("启动新测评失败，请稍后重试");return}window.location.reload()}async handleViewReport(){var t,i;(i=(t=l).triggerHaptic)==null||i.call(t,"light");const{openSimpleReport:e}=await r(async()=>{const{openSimpleReport:a}=await import("./simple-report-entry-BDExxS54.js");return{openSimpleReport:a}},__vite__mapDeps([6,1,2,3]),import.meta.url);await e({backTarget:"simple-complete-guide"})}render(){const e=window.innerHeight>window.innerWidth;return`
